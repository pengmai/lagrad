...
//       : ConversionPattern(standalone::DiffOp::getOperationName(),
//       /*benefit=*/1,
//                           context) {}
//   LogicalResult
...
//     time. auto primalType =
//     op->getOperand(0).getType().dyn_cast<FunctionType>(); auto floatType =
//     getScalarFloatType(primalType.getInput(0));
...
//     // Following the autograd-style API, we want to take the result of the
//     diff
...
//                                 user->getLoc(),
//                                 typeConverter.convertType(arg.getType()),
//                                 arg)
//                             .getResult(0);
...
// private:
//   static FlatSymbolRefAttr getOrInsertEnzymeConstDecl(PatternRewriter
//   &rewriter,
//                                                       Operation *op) {
...
//     auto voidPtrType = LLVM::LLVMPointerType::get(IntegerType::get(context,
//     8));

//     auto llvmFnType =
//         LLVM::LLVMFunctionType::get(returnType, voidPtrType,
//         /*isVarArg=*/true);
