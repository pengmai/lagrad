...
func @main() {
  ...
  %f = constant @collapsed : (tensor<4x4x4xf64>) -> tensor<4x4xf64>
  %df = standalone.grad %f : (tensor<4x4x4xf64>) -> tensor<4x4xf64>, (tensor<4x4x4xf64>) -> tensor<4x4x4xf64>
  %res = call_indirect %df(%t) : (tensor<4x4x4xf64>) -> tensor<4x4x4xf64>
