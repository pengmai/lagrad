...
// second arg: sparse dense (d0, d1, d2) -> (d1, d0)

// d1 is sparse
// we need two loops, d0 and d2
// Questions: how many loops do we need? What are the bounds of the loops?
// What are the iteration variables?

// output: dense dense (d0, d1, d2) -> (d2, d0)
