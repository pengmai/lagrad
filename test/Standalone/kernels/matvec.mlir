...
func @__grad_matvec(%arg0: tensor<512x1024xf32>, %arg1: tensor<1024xf32>) -> tensor<512x1024xf32> {
  ...
  // *** linalg.generic with memrefs *** //
  // %cst_0m = tensor_to_memref %cst_0 : memref<512xf32>
  // %arg1m = tensor_to_memref %arg1 : memref<1024xf32>
  // %out = alloc() : memref<512x1024xf32>
  // linalg.generic
  //   {indexing_maps = [#map0, #map1, #map2], iterator_types = ["parallel", "parallel"]}
  //   ins(%cst_0m, %arg1m : memref<512xf32>, memref<1024xf32>)
  //   outs(%out : memref<512x1024xf32>) {
  // ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):
  //   %0 = mulf %arg2, %arg3 : f32
  //   // %1 = addf %0, %arg4 : f32
  //   linalg.yield %0 : f32
  // }
  // %0 = tensor_load %out : memref<512x1024xf32>
