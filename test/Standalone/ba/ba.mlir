...
func.func @mlir_compute_reproj_error(
  ...
  %cam_rot = tensor.extract_slice %cam[0] [3] [1] : tensor<11xf64> to tensor<3xf64>
  %cam_c = tensor.extract_slice %cam[3] [3] [1] : tensor<11xf64> to tensor<3xf64>
  %cam_rad = tensor.extract_slice %cam[9] [2] [1] : tensor<11xf64> to tensor<2xf64>

  %f_idx = arith.constant 6 : index
  %cam_f = tensor.extract %cam[%f_idx] : tensor<11xf64>
  %cam_x0 = tensor.extract_slice %cam[7] [2] [1] : tensor<11xf64> to tensor<2xf64>
