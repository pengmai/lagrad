...
func.func private @print_memref_f64(tensor<*xf64>) attributes { llvm.emit_c_interface }
...
func.func @mlir_hand_objective_complicated(
  %theta : tensor<26xf64>,
  %us : tensor<2x2xf64>,
...
func.func @lagrad_hand_objective_complicated(
  %theta : tensor<26xf64>,
  %us : tensor<2x2xf64>,
  %parents: tensor<22xi32>,
  %base_relatives: tensor<22x4x4xf64>,
