...
// func.func @cross_entropy(%activations: tensor<10xf32>, %label: index) -> f32 {
//   %c0 = arith.constant 0 : index
//   %c1 = arith.constant 1 : index
//   %cd = arith.constant 10 : index
...
//     %max_next = arith.select %p, %ai, %max_it : f32
...
// func.func private @print_memref_i32(tensor<*xi32>) attributes { llvm.emit_c_interface }
...
//     %nll = func.call @cross_entropy(%activations, %l_idx) : (tensor<10xf32>, index) -> f32
