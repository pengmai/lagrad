...
module  {
  ...
  func @enzyme_gmm_opt_tri(%alphas: memref<{{k}}xf64>, %means: memref<{{k}}x{{d}}xf64>, %Qs: memref<{{k}}x{{d}}xf64>, %Ls: memref<{{k}}x{{d}}x{{d}}xf64>, %x: memref<{{n}}x{{d}}xf64>, %wishart_gamma: f64, %wishart_m: i64) -> f64 {
