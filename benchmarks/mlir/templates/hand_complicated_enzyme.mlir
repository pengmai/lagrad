// Made by copying hand_enzyme.mlir and modifying the parts to make it complicated.
...
#map8 = affine_map<(d0, d1, d2) -> (d2, d0)>
#map9 = affine_map<(d0, d1, d2) -> (d1, d2)>
#map10 = affine_map<(d0, d1, d2) -> (d1, d0)>
#map11 = affine_map<(d0, d1) -> (d1)>
module  {
  memref.global "private" constant @__constant_{{nverts}}x4xf64 : memref<{{nverts}}x4xf64> = dense<0.000000e+00>
  memref.global "private" constant @__constant_22x4x4xf64 : memref<22x4x4xf64> = dense<0.000000e+00>
  memref.global "private" constant @__constant_{{nverts}}x3xf64 : memref<{{nverts}}x3xf64> = dense<0.000000e+00>
  ...
  func @eto_pose_params(%arg0: memref<26xf64>) -> memref<25x3xf64> {
    ...
    %0 = memref.alloc() : memref<25x3xf64>
    linalg.fill(%cst_0, %0) : f64, memref<25x3xf64> 
    scf.for %arg1 = %c0 to %c3 step %c1 {
      %2 = memref.load %arg0[%arg1] : memref<26xf64>
      %3 = arith.addi %arg1, %c3 : index
      %4 = memref.load %arg0[%3] : memref<26xf64>
      memref.store %2, %0[%c0, %arg1] : memref<25x3xf64>
      memref.store %cst, %0[%c1, %arg1] : memref<25x3xf64>
      memref.store %4, %0[%c2, %arg1] : memref<25x3xf64>
    }
    %1:2 = scf.for %arg1 = %c0 to %c5 step %c1 iter_args(%arg2 = %c6, %arg3 = %c5) -> (index, index) {
      %2 = memref.load %arg0[%arg2] : memref<26xf64>
      %3 = arith.addi %arg2, %c1 : index
      %4 = memref.load %arg0[%3] : memref<26xf64>
      %5 = arith.addi %arg2, %c2 : index
      %6 = memref.load %arg0[%5] : memref<26xf64>
      %7 = arith.addi %arg2, %c3 : index
      %8 = memref.load %arg0[%7] : memref<26xf64>
      %9 = arith.addi %arg2, %c4 : index
      memref.store %2, %0[%arg3, %c0] : memref<25x3xf64>
      memref.store %4, %0[%arg3, %c1] : memref<25x3xf64>
      %10 = arith.addi %arg3, %c1 : index
      memref.store %6, %0[%10, %c0] : memref<25x3xf64>
      %11 = arith.addi %arg3, %c2 : index
      memref.store %8, %0[%11, %c0] : memref<25x3xf64>
      %12 = arith.addi %arg3, %c4 : index
      scf.yield %9, %12 : index, index
    }
    return %0 : memref<25x3xf64>
  }
  ...
  func @eeuler_angles_to_rotation_matrix(%arg0: memref<3xf64>) -> memref<3x3xf64> attributes {pure = true} {
    ...
    linalg.fill(%cst_0, %3) : f64, memref<3x3xf64> 
    %4 = math.cos %0 : f64
    ...
    memref.store %cst, %3[%c0, %c0] : memref<3x3xf64>
    %7 = memref.alloca() : memref<3x3xf64>
    linalg.fill(%cst_0, %7) : f64, memref<3x3xf64> 
    %8 = math.cos %1 : f64
    ...
    memref.store %cst, %7[%c1, %c1] : memref<3x3xf64>
    %11 = memref.alloca() : memref<3x3xf64>
    linalg.fill(%cst_0, %11) : f64, memref<3x3xf64> 
    %12 = math.cos %2 : f64
    ...
    memref.store %cst, %11[%c2, %c2] : memref<3x3xf64>
    %15 = memref.get_global @__constant_3x3xf64_0 : memref<3x3xf64>
    %16 = memref.alloca() : memref<3x3xf64>
  ...
  func @emlir_hand_objective_complicated(%arg0: memref<{{ntheta}}xf64>, %us: memref<{{npts}}x2xf64>, %arg1: memref<{{nbones}}xi32>, %arg2: memref<{{nbones}}x4x4xf64>, %arg3: memref<{{nbones}}x4x4xf64>, %arg4: memref<{{nverts}}x4xf64>, %arg5: memref<{{nverts}}x{{nbones}}xf64>, %triangles: memref<{{ntriangles}}x3xi32>, %arg6: memref<{{npts}}xi32>, %arg7: memref<{{npts}}x3xf64>, %out: memref<{{npts}}x3xf64>) -> f64 {
    ...
    %11 = memref.get_global @__constant_{{nverts}}x4xf64 : memref<{{nverts}}x4xf64>
    %12 = scf.for %arg8 = %c0 to %cb step %c1 iter_args(%arg9 = %10) -> (memref<{{nverts}}x3xf64>) {
      ...
      linalg.generic {doc = "Column-major matrix multiplication", indexing_maps = [#map8, #map9, #map10], iterator_types = ["parallel", "parallel", "reduction"]} ins(%28, %arg4 : memref<4x4xf64>, memref<{{nverts}}x4xf64>) outs(%29 : memref<{{nverts}}x4xf64>) {
      ^bb0(%arg10: f64, %arg11: f64, %arg12: f64):  // no predecessors
      ...
      %31 = memref.subview %29[0, 0] [{{nverts}}, 3] [1, 1] : memref<{{nverts}}x4xf64> to memref<{{nverts}}x3xf64, #map3>
      linalg.copy(%31, %30) : memref<{{nverts}}x3xf64, #map3>, memref<{{nverts}}x3xf64> 
      %32 = memref.subview %arg5[0, %arg8] [{{nverts}}, 1] [1, 1] : memref<{{nverts}}x{{nbones}}xf64> to memref<{{nverts}}xf64, #map2>
      ...
      linalg.generic {indexing_maps = [#map6, #map7, #map6], iterator_types = ["parallel", "parallel"]} ins(%30, %33 : memref<{{nverts}}x3xf64>, memref<{{nverts}}xf64>) outs(%34 : memref<{{nverts}}x3xf64>) {
      ^bb0(%arg10: f64, %arg11: f64, %arg12: f64):  // no predecessors
        %35 = arith.mulf %arg10, %arg11 : f64
        %36 = arith.addf %35, %arg12 : f64
        linalg.yield %36 : f64
    ...
    linalg.generic {indexing_maps = [#map6, #map7, #map6], iterator_types = ["parallel", "parallel"]} ins(%19, %16 : memref<3x3xf64>, memref<3xf64>) outs(%21 : memref<3x3xf64>) {
    ^bb0(%arg8: f64, %arg9: f64, %arg10: f64):  // no predecessors
      %27 = arith.mulf %arg8, %arg9 : f64
      linalg.yield %27 : f64
    }
    %22 = memref.get_global @__constant_{{nverts}}x3xf64 : memref<{{nverts}}x3xf64>
    %23 = memref.alloc() : memref<{{nverts}}x3xf64>
    linalg.copy(%22, %23) : memref<{{nverts}}x3xf64>, memref<{{nverts}}x3xf64> 
    linalg.generic {doc = "Column-major matrix multiplication", indexing_maps = [#map8, #map9, #map10], iterator_types = ["parallel", "parallel", "reduction"]} ins(%21, %12 : memref<3x3xf64>, memref<{{nverts}}x3xf64>) outs(%23 : memref<{{nverts}}x3xf64>) {
    ^bb0(%arg8: f64, %arg9: f64, %arg10: f64):  // no predecessors
      %27 = arith.mulf %arg8, %arg9 : f64
    ...
    linalg.generic {indexing_maps = [#map6, #map11, #map6], iterator_types = ["parallel", "parallel"]} ins(%23, %18 : memref<{{nverts}}x3xf64>, memref<3xf64>) outs(%24 : memref<{{nverts}}x3xf64>) {
    ^bb0(%arg8: f64, %arg9: f64, %arg10: f64):  // no predecessors
    ...
    scf.for %arg10 = %c0 to %cpts step %c1 {
      scf.for %arg11 = %c0 to %c3 step %c1 {
        ...
        %onemu = arith.subf %cst_0, %usum : f64
