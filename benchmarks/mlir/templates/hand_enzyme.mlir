...
module  {
  ...
  memref.global "private" constant @__constant_22x4x4xf64 : memref<22x4x4xf64> = dense<0.000000e+00>
  ...
  func @eto_pose_params(%arg0: memref<26xf64>) -> memref<25x3xf64> {
    %cst = arith.constant 0.000000e+00 : f64
    %cst_0 = arith.constant 1.000000e+00 : f64
    %0 = memref.get_global @__constant_3xf64 : memref<3xf64>
    %1 = memref.alloc() : memref<25x3xf64>
    linalg.fill(%cst, %1) : f64, memref<25x3xf64> 
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c2 = arith.constant 2 : index
    %c3 = arith.constant 3 : index
    %c5 = arith.constant 5 : index
    %2 = scf.for %arg1 = %c0 to %c3 step %c1 iter_args(%arg2 = %1) -> (memref<25x3xf64>) {
      %4 = memref.load %arg0[%arg1] : memref<26xf64>
      %5 = arith.addi %arg1, %c3 : index
      %6 = memref.load %arg0[%5] : memref<26xf64>
      memref.store %4, %arg2[%c0, %arg1] : memref<25x3xf64>
      memref.store %cst_0, %arg2[%c1, %arg1] : memref<25x3xf64>
      memref.store %6, %arg2[%c2, %arg1] : memref<25x3xf64>
      scf.yield %arg2 : memref<25x3xf64>
    }
    %c6 = arith.constant 6 : index
    %c5_1 = arith.constant 5 : index
    %3:3 = scf.for %arg1 = %c0 to %c5 step %c1 iter_args(%arg2 = %2, %arg3 = %c6, %arg4 = %c5_1) -> (memref<25x3xf64>, index, index) {
      %4 = memref.load %arg0[%arg3] : memref<26xf64>
      %5 = arith.addi %arg3, %c1 : index
      %6 = memref.load %arg0[%5] : memref<26xf64>
      %7 = arith.addi %5, %c1 : index
      %8 = memref.load %arg0[%7] : memref<26xf64>
      %9 = arith.addi %7, %c1 : index
      %10 = memref.load %arg0[%9] : memref<26xf64>
      %11 = arith.addi %9, %c1 : index
      memref.store %4, %arg2[%arg4, %c0] : memref<25x3xf64>
      memref.store %6, %arg2[%arg4, %c1] : memref<25x3xf64>
      %12 = arith.addi %arg4, %c1 : index
      memref.store %8, %arg2[%12, %c0] : memref<25x3xf64>
      %13 = arith.addi %12, %c1 : index
      memref.store %10, %arg2[%13, %c0] : memref<25x3xf64>
      %14 = arith.addi %13, %c2 : index
      scf.yield %arg2, %11, %14 : memref<25x3xf64>, index, index
    }
    return %3#0 : memref<25x3xf64>
  }
  ...
  func @emlir_hand_objective(%arg0: memref<26xf64>, %arg1: memref<22xi32>, %arg2: memref<22x4x4xf64>, %arg3: memref<22x4x4xf64>, %arg4: memref<544x4xf64>, %arg5: memref<544x22xf64>, %arg6: memref<2xi32>, %arg7: memref<2x3xf64>, %out: memref<2x3xf64>) -> f64 {
    %0 = call @eto_pose_params(%arg0) : (memref<26xf64>) -> memref<25x3xf64>
    %cpy0 = memref.alloc() : memref<25x3xf64>
    linalg.copy(%0, %cpy0) : memref<25x3xf64>, memref<25x3xf64>
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c3 = arith.constant 3 : index
    ...
    %4 = memref.alloc() : memref<22x4x4xf64>

    %5 = scf.for %arg8 = %c0 to %c22 step %c1 iter_args(%arg9 = %4) -> (memref<22x4x4xf64>) {
      %27 = arith.addi %arg8, %c3 : index
      %28 = memref.subview %cpy0[%27, 0] [1, 3] [1, 1] : memref<25x3xf64> to memref<3xf64, #mapS>
      ...
      %35 = memref.subview %arg2[%arg8, 0, 0] [1, 4, 4] [1, 1, 1] : memref<22x4x4xf64> to memref<4x4xf64, #map4>
      ...
      %37 = memref.subview %arg9[%arg8, 0, 0] [1, 4, 4] [1, 1, 1] : memref<22x4x4xf64> to memref<4x4xf64, #map4>
      linalg.copy(%36, %37) : memref<4x4xf64>, memref<4x4xf64, #map4> 
      scf.yield %arg9 : memref<22x4x4xf64>
    }
    %c-1_i32 = arith.constant -1 : i32
    %6 = memref.alloc() : memref<22x4x4xf64>
    %7 = scf.for %arg8 = %c0 to %c22 step %c1 iter_args(%arg9 = %6) -> (memref<22x4x4xf64>) {
      %27 = memref.load %arg1[%arg8] : memref<22xi32>
      %28 = memref.subview %5[%arg8, 0, 0] [1, 4, 4] [1, 1, 1] : memref<22x4x4xf64> to memref<4x4xf64, #map4>
      ...
      %31 = scf.if %30 -> (memref<4x4xf64>) {
        ...
        %34 = memref.subview %arg9[%33, 0, 0] [1, 4, 4] [1, 1, 1] : memref<22x4x4xf64> to memref<4x4xf64, #map4>
      ...
      %32 = memref.subview %arg9[%arg8, 0, 0] [1, 4, 4] [1, 1, 1] : memref<22x4x4xf64> to memref<4x4xf64, #map4>
      linalg.copy(%31, %32) : memref<4x4xf64>, memref<4x4xf64, #map4> 
      scf.yield %arg9 : memref<22x4x4xf64>
    }
    %8 = memref.get_global @__constant_22x4x4xf64 : memref<22x4x4xf64>
    %9 = memref.alloc() : memref<22x4x4xf64>
    linalg.copy(%8, %9) : memref<22x4x4xf64>, memref<22x4x4xf64> 
    linalg.batch_matmul ins(%arg3, %7 : memref<22x4x4xf64>, memref<22x4x4xf64>) outs(%9 : memref<22x4x4xf64>)
    %10 = memref.alloc() : memref<544x3xf64>
    linalg.fill(%cst, %10) : f64, memref<544x3xf64>
    %11 = memref.get_global @__constant_544x4xf64 : memref<544x4xf64>
    %12 = scf.for %arg8 = %c0 to %c22 step %c1 iter_args(%arg9 = %10) -> (memref<544x3xf64>) {
      %27 = memref.subview %9[%arg8, 0, 0] [1, 4, 4] [1, 1, 1] : memref<22x4x4xf64> to memref<4x4xf64, #map4>
      %28 = memref.cast %27 : memref<4x4xf64, #map4> to memref<4x4xf64>
      %29 = memref.alloc() : memref<544x4xf64>
      linalg.copy(%11, %29) : memref<544x4xf64>, memref<544x4xf64> 
      linalg.generic {doc = "Column-major matrix multiplication", indexing_maps = [#map5, #map6, #map7], iterator_types = ["parallel", "parallel", "reduction"]} ins(%28, %arg4 : memref<4x4xf64>, memref<544x4xf64>) outs(%29 : memref<544x4xf64>) {
      ^bb0(%arg10: f64, %arg11: f64, %arg12: f64):  // no predecessors
        %35 = arith.mulf %arg10, %arg11 : f64
        %36 = arith.addf %35, %arg12 : f64
        linalg.yield %36 : f64
      }
      %30 = memref.alloc() : memref<544x3xf64>
      %31 = memref.subview %29[0, 0] [544, 3] [1, 1] : memref<544x4xf64> to memref<544x3xf64, #map3>
      linalg.copy(%31, %30) : memref<544x3xf64, #map3>, memref<544x3xf64> 
      %32 = memref.subview %arg5[0, %arg8] [544, 1] [1, 1] : memref<544x22xf64> to memref<544xf64, #map2>
      %33 = memref.cast %32 : memref<544xf64, #map2> to memref<544xf64>
      %34 = memref.alloc() : memref<544x3xf64>
      linalg.copy(%arg9, %34) : memref<544x3xf64>, memref<544x3xf64> 
      linalg.generic {indexing_maps = [#map8, #map9, #map8], iterator_types = ["parallel", "parallel"]} ins(%30, %33 : memref<544x3xf64>, memref<544xf64>) outs(%34 : memref<544x3xf64>) {
      ^bb0(%arg10: f64, %arg11: f64, %arg12: f64):  // no predecessors
        %35 = arith.mulf %arg10, %arg11 : f64
        %36 = arith.addf %35, %arg12 : f64
        linalg.yield %36 : f64
      }
      scf.yield %34 : memref<544x3xf64>
    }
    %13 = memref.subview %0[0, 0] [1, 3] [1, 1] : memref<25x3xf64> to memref<3xf64, #map2>
    %14 = memref.cast %13 : memref<3xf64, #map2> to memref<3xf64>
    %15 = memref.subview %0[1, 0] [1, 3] [1, 1] : memref<25x3xf64> to memref<3xf64, #map2>
    %16 = memref.cast %15 : memref<3xf64, #map2> to memref<3xf64>
    %17 = memref.subview %0[2, 0] [1, 3] [1, 1] : memref<25x3xf64> to memref<3xf64, #map2>
    ...
    %22 = memref.get_global @__constant_544x3xf64 : memref<544x3xf64>
    %23 = memref.alloc() : memref<544x3xf64>
    linalg.copy(%22, %23) : memref<544x3xf64>, memref<544x3xf64> 
    linalg.generic {doc = "Column-major matrix multiplication", indexing_maps = [#map5, #map6, #map7], iterator_types = ["parallel", "parallel", "reduction"]} ins(%21, %12 : memref<3x3xf64>, memref<544x3xf64>) outs(%23 : memref<544x3xf64>) {
    ^bb0(%arg8: f64, %arg9: f64, %arg10: f64):  // no predecessors
      %27 = arith.mulf %arg8, %arg9 : f64
      %28 = arith.addf %27, %arg10 : f64
      linalg.yield %28 : f64
    }
    %24 = memref.alloc() : memref<544x3xf64>
    linalg.generic {indexing_maps = [#map8, #map10, #map8], iterator_types = ["parallel", "parallel"]} ins(%23, %18 : memref<544x3xf64>, memref<3xf64>) outs(%24 : memref<544x3xf64>) {
    ^bb0(%arg8: f64, %arg9: f64, %arg10: f64):  // no predecessors
      %27 = arith.addf %arg8, %arg9 : f64
      linalg.yield %27 : f64
    }
    %25 = memref.alloc() : memref<2x3xf64>
    %c2 = arith.constant 2 : index
    %26 = scf.for %arg8 = %c0 to %c2 step %c1 iter_args(%arg9 = %25) -> (memref<2x3xf64>) {
      %27 = scf.for %arg10 = %c0 to %c3 step %c1 iter_args(%arg11 = %arg9) -> (memref<2x3xf64>) {
        %28 = memref.load %arg7[%arg8, %arg10] : memref<2x3xf64>
        %29 = memref.load %arg6[%arg8] : memref<2xi32>
        %30 = arith.index_cast %29 : i32 to index
        %31 = memref.load %24[%30, %arg10] : memref<544x3xf64>
        %32 = arith.subf %28, %31 : f64
        memref.store %32, %arg11[%arg8, %arg10] : memref<2x3xf64>
        scf.yield %arg11 : memref<2x3xf64>
      }
      scf.yield %27 : memref<2x3xf64>
    }
    linalg.copy(%26, %out) : memref<2x3xf64>, memref<2x3xf64>
    %ret = arith.constant 0.0 : f64
    return %ret : f64
  }

  func @enzyme_hand_objective(%arg0: memref<26xf64>, %arg1: memref<22xi32>, %arg2: memref<22x4x4xf64>, %arg3: memref<22x4x4xf64>, %arg4: memref<544x4xf64>, %arg5: memref<544x22xf64>, %arg6: memref<2xi32>, %arg7: memref<2x3xf64>, %g: memref<2x3xf64>) -> memref<{{ntheta}}xf64> {
    %dtheta = memref.alloc() : memref<{{ntheta}}xf64>
    %out = memref.alloca() : memref<{{npts}}x3xf64>
