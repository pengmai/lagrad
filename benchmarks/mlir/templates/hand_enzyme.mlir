...
module  {
  ...
  func @emlir_hand_objective(%arg0: memref<{{ntheta}}xf64>, %arg1: memref<{{nbones}}xi32>, %arg2: memref<{{nbones}}x4x4xf64>, %arg3: memref<{{nbones}}x4x4xf64>, %arg4: memref<{{nverts}}x4xf64>, %arg5: memref<{{nverts}}x{{nbones}}xf64>, %arg6: memref<{{npts}}xi32>, %arg7: memref<{{npts}}x3xf64>, %out: memref<{{primal_shape}}xf64>) -> f64 {
  ...
  func @enzyme_hand_objective(%arg0: memref<{{ntheta}}xf64>, %arg1: memref<{{nbones}}xi32>, %arg2: memref<{{nbones}}x4x4xf64>, %arg3: memref<{{nbones}}x4x4xf64>, %arg4: memref<{{nverts}}x4xf64>, %arg5: memref<{{nverts}}x{{nbones}}xf64>, %arg6: memref<{{npts}}xi32>, %arg7: memref<{{npts}}x3xf64>, %g: memref<{{npts}}x3xf64>) -> memref<{{ntheta}}xf64> {
    ...
    // %dout = memref.alloc() : memref<{{primal_shape}}xf64>
    %out = memref.alloc() : memref<{{primal_shape}}xf64>
    %zero = arith.constant 0.0 : f64
    linalg.fill(%zero, %dtheta) : f64, memref<{{ntheta}}xf64>
    linalg.fill(%zero, %out) : f64, memref<{{primal_shape}}xf64>
    // %one = arith.constant 1.0 : f64
    // linalg.fill(%one, %dout) : f64, memref<{{primal_shape}}xf64>
