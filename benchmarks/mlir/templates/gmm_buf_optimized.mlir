...
module  {
  ...
  func @enzyme_gmm_opt_full(%alphas: memref<{{k}}xf64>, %means: memref<{{k}}x{{d}}xf64>, %Qs: memref<{{k}}x{{d}}xf64>, %Ls: memref<{{k}}x{{d}}x{{d}}xf64>, %x: memref<{{n}}x{{d}}xf64>, %wishart_gamma: f64, %wishart_m: i64) -> f64 {
  ...
  func @enzyme_gmm_opt_diff_full(
    ...
    %f = constant @enzyme_gmm_opt_full : (memref<{{k}}xf64>, memref<{{k}}x{{d}}xf64>, memref<{{k}}x{{d}}xf64>, memref<{{k}}x{{d}}x{{d}}xf64>, memref<{{n}}x{{d}}xf64>, f64, i64) -> f64
