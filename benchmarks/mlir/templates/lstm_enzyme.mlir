...
module  {
  ...
  func @emlstm_objective(%arg0: memref<{{l}}x2x4x{{b}}xf64>, %arg1: memref<3x{{b}}xf64>, %arg2: memref<{{l}}x2x{{b}}xf64>, %arg3: memref<{{c}}x{{b}}xf64>) -> f64 {
    ...
    %10:2 = scf.for %arg4 = %c0 to %ccm1 step %c1 iter_args(%arg5 = %cst, %arg6 = %c0) -> (f64, index) {
      ...
      linalg.generic {indexing_maps = [#map0, #map0, #map0], iterator_types = ["parallel"]} ins(%16, %18 : memref<{{b}}xf64>, memref<{{b}}xf64>) outs(%1 : memref<{{b}}xf64>) {
      ^bb0(%arg7: f64, %arg8: f64, %arg9: f64):  // no predecessors
        %32 = arith.mulf %arg7, %arg8 : f64
        linalg.yield %32 : f64
      }
      %19 = memref.alloc() : memref<{{b}}xf64>
      %20 = scf.for %arg7 = %c0 to %cl step %c1 iter_args(%arg8 = %1) -> (memref<{{b}}xf64>) {
        ...
        linalg.generic {indexing_maps = [#map0, #map0, #map0, #map0], iterator_types = ["parallel"]} ins(%arg8, %33, %35 : memref<{{b}}xf64>, memref<{{b}}xf64>, memref<{{b}}xf64>) outs(%2 : memref<{{b}}xf64>) {
        ...
        linalg.generic {indexing_maps = [#map0, #map0, #map0, #map0], iterator_types = ["parallel"]} ins(%49, %37, %39 : memref<{{b}}xf64>, memref<{{b}}xf64>, memref<{{b}}xf64>) outs(%3 : memref<{{b}}xf64>) {
        ^bb0(%arg9: f64, %arg10: f64, %arg11: f64, %arg12: f64):  // no predecessors
          %54 = arith.mulf %arg9, %arg10 : f64
          %55 = arith.addf %54, %arg11 : f64
          %56 = call @emsigmoid(%55) : (f64) -> f64
        ...
        linalg.generic {indexing_maps = [#map0, #map0, #map0, #map0], iterator_types = ["parallel"]} ins(%arg8, %41, %43 : memref<{{b}}xf64>, memref<{{b}}xf64>, memref<{{b}}xf64>) outs(%4 : memref<{{b}}xf64>) {
        ^bb0(%arg9: f64, %arg10: f64, %arg11: f64, %arg12: f64):  // no predecessors
          %54 = arith.mulf %arg9, %arg10 : f64
          %55 = arith.addf %54, %arg11 : f64
          %56 = call @emsigmoid(%55) : (f64) -> f64
        ...
        linalg.generic {indexing_maps = [#map0, #map0, #map0, #map0], iterator_types = ["parallel"]} ins(%49, %45, %47 : memref<{{b}}xf64>, memref<{{b}}xf64>, memref<{{b}}xf64>) outs(%5 : memref<{{b}}xf64>) {
        ^bb0(%arg9: f64, %arg10: f64, %arg11: f64, %arg12: f64):  // no predecessors
          %54 = arith.mulf %arg9, %arg10 : f64
          %55 = arith.addf %54, %arg11 : f64
          %56 = math.tanh %55 : f64
        ...
        linalg.generic {indexing_maps = [#map0, #map0, #map0, #map0, #map0], iterator_types = ["parallel"]} ins(%51, %2, %3, %5 : memref<{{b}}xf64>, memref<{{b}}xf64>, memref<{{b}}xf64>, memref<{{b}}xf64>) outs(%6 : memref<{{b}}xf64>) {
        ...
        linalg.generic {indexing_maps = [#map0, #map0, #map0], iterator_types = ["parallel"]} ins(%4, %6 : memref<{{b}}xf64>, memref<{{b}}xf64>) outs(%19 : memref<{{b}}xf64>) {
      ...
      linalg.generic {indexing_maps = [#map0, #map0, #map0, #map0], iterator_types = ["parallel"]} ins(%20, %22, %24 : memref<{{b}}xf64>, memref<{{b}}xf64>, memref<{{b}}xf64>) outs(%7 : memref<{{b}}xf64>) {
      ^bb0(%arg7: f64, %arg8: f64, %arg9: f64, %arg10: f64):  // no predecessors
        %32 = arith.mulf %arg7, %arg8 : f64
        %33 = arith.addf %32, %arg9 : f64
        linalg.yield %33 : f64
      }
      %25 = call @emlogsumexp(%7) : (memref<{{b}}xf64>) -> f64
      linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel"]} ins(%7 : memref<{{b}}xf64>) outs(%8 : memref<{{b}}xf64>) {
      ...
      linalg.dot ins(%28, %8 : memref<{{b}}xf64>, memref<{{b}}xf64>) outs(%9 : memref<f64>)
