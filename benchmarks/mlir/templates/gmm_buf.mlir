...
module  {
  ...
  func @enzyme_gmm_opt_compressed(%arg0: memref<25xf64>, %arg1: memref<25x10xf64>, %arg2: memref<25x10xf64>, %arg3: memref<25x45xf64>, %arg4: memref<1000x10xf64>, %arg5: f64, %arg6: i64) -> f64 {
    %cst = arith.constant 0.000000e+00 : f64
    // %0 = memref.alloc() : memref<25x10xf64>
    // memref.dealloc %0 : memref<25x10xf64>
    %1 = memref.get_global @__constant_25xf64 : memref<25xf64>
    %2 = memref.get_global @__constant_10xf64 : memref<10xf64>
    %3 = memref.alloc() : memref<10xf64>
    %4 = memref.alloc() : memref<25xf64>
    %5 = memref.get_global @__constant_xf64 : memref<f64>
    %6 = memref.alloc() : memref<f64>
    %7 = memref.alloc() : memref<25x10xf64>
    linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel", "parallel"]} ins(%arg2 : memref<25x10xf64>) outs(%7 : memref<25x10xf64>) {
    ^bb0(%arg7: f64, %arg8: f64):  // no predecessors
      %32 = math.exp %arg7 : f64
      linalg.yield %32 : f64
    }
    %8 = memref.alloc() : memref<25xf64>
    linalg.copy(%1, %8) : memref<25xf64>, memref<25xf64> 
    linalg.generic {indexing_maps = [#map0, #map1], iterator_types = ["parallel", "reduction"]} ins(%arg2 : memref<25x10xf64>) outs(%8 : memref<25xf64>) {
    ^bb0(%arg7: f64, %arg8: f64):  // no predecessors
    ...
    %9 = memref.alloc() : memref<10xf64>
    %10 = memref.alloc() : memref<10xf64>
    %11 = memref.alloc() : memref<10xf64>
    %12 = memref.alloc() : memref<f64>
    %13 = memref.alloc() : memref<f64>
    %14 = memref.alloc() : memref<f64>
    %15 = scf.for %arg7 = %c0 to %c1000 step %c1 iter_args(%arg8 = %cst) -> (f64) {
      %32 = scf.for %arg9 = %c0 to %c25 step %c1 iter_args(%arg10 = %4) -> (memref<25xf64>) {
        %39 = memref.subview %arg4[%arg7, 0] [1, 10] [1, 1] : memref<1000x10xf64> to memref<10xf64, #map2>
        %40 = memref.cast %39 : memref<10xf64, #map2> to memref<10xf64>
        %41 = memref.subview %arg1[%arg9, 0] [1, 10] [1, 1] : memref<25x10xf64> to memref<10xf64, #map2>
        %42 = memref.cast %41 : memref<10xf64, #map2> to memref<10xf64>
        linalg.generic {indexing_maps = [#map3, #map3, #map3], iterator_types = ["parallel"]} ins(%40, %42 : memref<10xf64>, memref<10xf64>) outs(%9 : memref<10xf64>) {
        ^bb0(%arg11: f64, %arg12: f64, %arg13: f64):  // no predecessors
          %54 = arith.subf %arg11, %arg12 : f64
          linalg.yield %54 : f64
        }
        %43 = memref.subview %7[%arg9, 0] [1, 10] [1, 1] : memref<25x10xf64> to memref<10xf64, #map2>
        %44 = memref.cast %43 : memref<10xf64, #map2> to memref<10xf64>
        %45 = memref.subview %arg3[%arg9, 0] [1, 45] [1, 1] : memref<25x45xf64> to memref<45xf64, #map2>
        %46 = memref.cast %45 : memref<45xf64, #map2> to memref<45xf64>
        linalg.generic {indexing_maps = [#map3, #map3, #map3], iterator_types = ["parallel"]} ins(%44, %9 : memref<10xf64>, memref<10xf64>) outs(%10 : memref<10xf64>) {
        ^bb0(%arg11: f64, %arg12: f64, %arg13: f64):  // no predecessors
          %54 = arith.mulf %arg11, %arg12 : f64
          linalg.yield %54 : f64
        }
        linalg.fill(%cst, %3) : f64, memref<10xf64> 
        %47 = scf.for %arg11 = %c0 to %c10 step %c1 iter_args(%arg12 = %3) -> (memref<10xf64>) {
          ...
          %59:2 = scf.for %arg13 = %58 to %c10 step %c1 iter_args(%arg14 = %arg12, %arg15 = %57) -> (memref<10xf64>, index) {
            %60 = memref.load %46[%arg15] : memref<45xf64>
            %61 = memref.load %9[%arg11] : memref<10xf64>
            %62 = memref.load %arg14[%arg13] : memref<10xf64>
            %63 = arith.mulf %60, %61 : f64
            %64 = arith.addf %63, %62 : f64
            memref.store %64, %arg14[%arg13] : memref<10xf64>
            %65 = arith.addi %arg15, %c1 : index
            scf.yield %arg14, %65 : memref<10xf64>, index
          }
          scf.yield %59#0 : memref<10xf64>
        }
        linalg.generic {indexing_maps = [#map3, #map3, #map3], iterator_types = ["parallel"]} ins(%10, %47 : memref<10xf64>, memref<10xf64>) outs(%11 : memref<10xf64>) {
        ^bb0(%arg11: f64, %arg12: f64, %arg13: f64):  // no predecessors
          %54 = arith.addf %arg11, %arg12 : f64
          linalg.yield %54 : f64
        }
        linalg.copy(%5, %12) : memref<f64>, memref<f64> 
        linalg.generic {indexing_maps = [#map3, #map4], iterator_types = ["reduction"]} ins(%11 : memref<10xf64>) outs(%12 : memref<f64>) {
        ...
        %50 = memref.load %arg0[%arg9] : memref<25xf64>
        %51 = memref.load %8[%arg9] : memref<25xf64>
        %52 = arith.addf %50, %51 : f64
        %53 = arith.subf %52, %49 : f64
        memref.store %53, %arg10[%arg9] : memref<25xf64>
        scf.yield %arg10 : memref<25xf64>
      }
      %33 = memref.load %32[%c0] : memref<25xf64>
      memref.store %33, %6[] : memref<f64>
      linalg.copy(%6, %13) : memref<f64>, memref<f64> 
      linalg.generic {indexing_maps = [#map3, #map4], iterator_types = ["reduction"]} ins(%32 : memref<25xf64>) outs(%13 : memref<f64>) {
      ...
      linalg.generic {indexing_maps = [#map3, #map4], iterator_types = ["reduction"]} ins(%32 : memref<25xf64>) outs(%14 : memref<f64>) {
      ^bb0(%arg9: f64, %arg10: f64):  // no predecessors
    ...
    memref.dealloc %11 : memref<10xf64>
    memref.dealloc %10 : memref<10xf64>
    memref.dealloc %9 : memref<10xf64>
    memref.dealloc %4 : memref<25xf64>
    memref.dealloc %3 : memref<10xf64>
    %16 = memref.load %arg0[%c0] : memref<25xf64>
    memref.store %16, %6[] : memref<f64>
    %17 = memref.alloc() : memref<f64>
    linalg.copy(%6, %17) : memref<f64>, memref<f64> 
    memref.dealloc %6 : memref<f64>
    linalg.generic {indexing_maps = [#map3, #map4], iterator_types = ["reduction"]} ins(%arg0 : memref<25xf64>) outs(%17 : memref<f64>) {
    ^bb0(%arg7: f64, %arg8: f64):  // no predecessors
    ...
    memref.dealloc %17 : memref<f64>
    %19 = memref.get_global @__constant_xf64 : memref<f64>
    %20 = memref.alloc() : memref<f64>
    linalg.copy(%19, %20) : memref<f64>, memref<f64> 
    linalg.generic {indexing_maps = [#map3, #map4], iterator_types = ["reduction"]} ins(%arg0 : memref<25xf64>) outs(%20 : memref<f64>) {
    ^bb0(%arg7: f64, %arg8: f64):  // no predecessors
    ...
    %29 = scf.for %arg7 = %c0 to %c25 step %c1 iter_args(%arg8 = %cst) -> (f64) {
      %32 = memref.subview %7[%arg7, 0] [1, 10] [1, 1] : memref<25x10xf64> to memref<10xf64, #map2>
      %33 = memref.cast %32 : memref<10xf64, #map2> to memref<10xf64>
      linalg.copy(%5, %27) : memref<f64>, memref<f64> 
      linalg.generic {indexing_maps = [#map3, #map4], iterator_types = ["reduction"]} ins(%33 : memref<10xf64>) outs(%27 : memref<f64>) {
      ^bb0(%arg9: f64, %arg10: f64):  // no predecessors
      ...
      %35 = memref.subview %arg3[%arg7, 0] [1, 45] [1, 1] : memref<25x45xf64> to memref<45xf64, #map2>
      ...
      %43 = memref.load %8[%arg7] : memref<25xf64>
    ...
    memref.dealloc %8 : memref<25xf64>
    memref.dealloc %7 : memref<25x10xf64>
