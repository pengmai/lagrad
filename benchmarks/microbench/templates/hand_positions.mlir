func @calc_positions(%transforms: tensor<22x4x4xf64>, %base_positions: tensor<544x4xf64>, %weights: tensor<544x22xf64>) -> tensor<544x3xf64> {
...
func @dla_positions(%transforms: tensor<22x4x4xf64>, %base_positions: tensor<544x4xf64>, %weights: tensor<544x22xf64>) -> tensor<22x4x4xf64> {
  // %f = constant @calc_positions : (tensor<22x4x4xf64>, tensor<544x4xf64>, tensor<544x22xf64>) -> tensor<544x3xf64>
  // %df = standalone.grad %f {of = [0]} : (tensor<22x4x4xf64>, tensor<544x4xf64>, tensor<544x22xf64>) -> tensor<544x3xf64>, (tensor<22x4x4xf64>, tensor<544x4xf64>, tensor<544x22xf64>) -> tensor<22x4x4xf64>
  ...
  %res = call @__grad_calc_positions(%transforms, %base_positions, %weights) : (tensor<22x4x4xf64>, tensor<544x4xf64>, tensor<544x22xf64>) -> tensor<22x4x4xf64>
